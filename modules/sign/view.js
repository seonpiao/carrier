define(["libs/client/views/base", 'libs/client/dialog/dialog-plus', 'libs/client/validate/jquery.validator', 'libs/client/chalUtil', "models/userInfo"], function(Base, DIALOG, VALIDATOR, SHALUTIL, userInfo) {
